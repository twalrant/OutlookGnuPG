  ...
  public class GnuPGRibbon : Office.IRibbonExtensibility
  {
    ...
    public string GetCustomUI(string ribbonID)
    {
      ...
      if (ribbonID == "Microsoft.Outlook.Mail.Read")
      {
        ...
        ui = GetResourceText("CC.OutlookGnuPG.GnuPGRibbonRead.xml");
      }
      if (ribbonID == "Microsoft.Outlook.Mail.Compose")
      {
        // Retrieve the customized Ribbon XML.
        ui = GetResourceText("CC.OutlookGnuPG.GnuPGRibbonCompose.xml");
      }
      return ui;
    }
      ...
      GetCustomImage(Office.IRibbonControl control)
    {
      ...
      switch (control.Id)
      {
        ...
        case decryptButtonId:
          pictureDisp = ImageConverter.Convert(global::CC.OutlookGnuPG.Properties.Resources.lock_edit);
          break;
        case signButtonId:
        case verifyButtonId:
          pictureDisp = ImageConverter.Convert(global::CC.OutlookGnuPG.Properties.Resources.link_edit);
          break;
        case "settingsButtonNew":
        case "settingsButtonRead":
          pictureDisp = ImageConverter.Convert(global::CC.OutlookGnuPG.Properties.Resources.database_gear);
          break;
        case "aboutButtonNew":
        case "aboutButtonRead":
          pictureDisp = ImageConverter.Convert(global::CC.OutlookGnuPG.Properties.Resources.Logo);
          break;
      }
      return pictureDisp;
    }
